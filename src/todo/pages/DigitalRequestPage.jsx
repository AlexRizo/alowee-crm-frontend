...
export const DigitalRequestPage = () => {
    const { startSavingDigital, message } = useCalendarStore();
        ...
        <div className="bg-white w-full p-6 rounded shadow container mx-auto">
            ...
            <form className="flex flex-col gap-5" onSubmit={ onSubmit }>
                <div className="flex gap-4">
                    ...
                    <div className="flex flex-col gap-1 w-full">
                        <label htmlFor="printType">Orientación</label>
                        <select 
                            className="w-full p-2 bg-white selected:text-gray-800 border focus:outline-none focus:ring-2 focus:ring-sky-700 rounded transition disabled:bg-gray-200 disabled:text-gray-500"
                            name="orientation"
                        ...
                        >
                            <option value="vertical" className="text-gray-500" >Vertical</option>    
                            <option value="horizontal" className="text-gray-500" >Horizontal</option>    
                            <option value="cuadrado" className="text-gray-500" >Cuadrado</option>  
                        </select>
                        {
                ...
                <div className="flex gap-4">
                    <div className="flex flex-col gap-1 w-full">
                        <label htmlFor="printDescription">Contenido del diseño</label>
                        <textarea
                        ...
                        />
                        { 
                            errors.digitalDescription && <ErrorComponent error={ errors.digitalDescription.message } />
                        }
                    </div>
                    <div className="flex flex-col gap-1 w-full">
